set_property PACKAGE_PIN W22 [get_ports adc_clk]
set_property PACKAGE_PIN T19 [get_ports {adc_data[0]}]
set_property PACKAGE_PIN R19 [get_ports {adc_data[1]}]
set_property PACKAGE_PIN P15 [get_ports {adc_data[2]}]
set_property PACKAGE_PIN N15 [get_ports {adc_data[3]}]
set_property PACKAGE_PIN M16 [get_ports {adc_data[4]}]
set_property PACKAGE_PIN M15 [get_ports {adc_data[5]}]
set_property PACKAGE_PIN AB19 [get_ports {adc_data[6]}]
set_property PACKAGE_PIN AB20 [get_ports {adc_data[7]}]
